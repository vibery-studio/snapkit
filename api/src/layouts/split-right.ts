// Layout: Split Right - Text panel left 50%, image right 50% (mirror of split-left)
...
export const splitRightLayout: Layout = {
  id: 'split-right',
  name: 'Split Right',
  ...
  <div style="width:50%;height:100%;flex-shrink:0;overflow:hidden;background:#333;">
    ${hasImage ? `<img src="${imgUrl}" alt="" style="width:100%;height:100%;object-fit:cover;display:block;" crossorigin="anonymous" onerror="this.style.display='none'" />` : ''}
  </div>
  ${wmHtml}
</div>`;
  },
