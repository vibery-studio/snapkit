...
export const collage2Layout: Layout = {
  ...
  render(p: LayoutRenderParams): string {
    ...
    const hasImg1 = img1 && img1 !== 'undefined' && img1 !== 'null';
    const hasImg2 = img2 && img2 !== 'undefined' && img2 !== 'null';
  ...
  <div style="flex:1;display:flex;align-items:center;justify-content:center;gap:2%;padding:3% 5%;box-sizing:border-box;overflow:hidden;">
    <div style="width:46%;height:100%;overflow:hidden;border-radius:4px;background:#333;">
      ${hasImg1 ? `<img src="${img1}" alt="" style="width:100%;height:100%;object-fit:cover;display:block;" crossorigin="anonymous" onerror="this.style.display='none'" />` : ''}
    </div>
    <div style="width:46%;height:100%;overflow:hidden;border-radius:4px;background:#333;">
      ${hasImg2 ? `<img src="${img2}" alt="" style="width:100%;height:100%;object-fit:cover;display:block;" crossorigin="anonymous" onerror="this.style.display='none'" />` : ''}
    </div>
  </div>
