...
export const cardCenterLayout: Layout = {
  ...
  render(p: LayoutRenderParams): string {
    ...
    const logoHtml = safeLogo
      ? `<img src="${safeLogo}" alt="logo" style="position:absolute;top:5%;left:5%;height:12%;max-width:35%;object-fit:contain;" crossorigin="anonymous" onerror="this.style.display='none'" />`
      : '';
