...
import { escapeHtml, sanitizeColor, getOverlayGradient, sanitizeUrlForCss } from '../lib/html-helpers';
...
export const overlayCenterLayout: Layout = {
  ...
  render(p: LayoutRenderParams): string {
    ...
    const logoHtml = safeLogo
      ? `<img src="${safeLogo}" alt="logo" style="position:absolute;top:5%;right:5%;height:8%;object-fit:contain;" crossorigin="anonymous" onerror="this.style.display='none'" />`
      : '';
